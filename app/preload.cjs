...
contextBridge.exposeInMainWorld('api', {
  ...
  removeDevice: (key) => ipcRenderer.invoke('engine:removeDevice', key),
  rekeyVault: (newPassphrase) => ipcRenderer.invoke('engine:rekeyVault', newPassphrase),
  credsCheck: (verify) => ipcRenderer.invoke('engine:credsCheck', verify),
  resetIdentity: () => ipcRenderer.invoke('engine:resetIdentity'),
